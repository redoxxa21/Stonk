...
import io.stonk.portfolio.exception.UserNotFoundException;
import io.stonk.portfolio.exception.UserServiceUnauthorizedException;
...
public class HttpUserDirectoryClient implements UserDirectoryClient {
    ...
    public HttpUserDirectoryClient(RestTemplate restTemplate,
                                   @Value("${portfolio.user-service-base-url:http://localhost:2700}") String userServiceBaseUrl) {
